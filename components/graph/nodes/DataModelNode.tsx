...
export function DataModelNode({ data }: NodeProps) {
  ...
  return (
    <>
      ...
      <div
        aria-label={label}
        className="flex flex-col gap-2 w-48 px-3 py-2.5 rounded-lg bg-background border-2 border-amber-500 shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      >
