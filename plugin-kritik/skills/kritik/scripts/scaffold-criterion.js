...
`)}var f=require("node:fs"),u=require("node:path");var F="docs/quality";var N="criteria.custom.json";var I="library.json";function Q(e,t){return[...t!==void 0?[(0,u.join)(t,F,I)]:[],(0,u.join)(e,"..","references",I),(0,u.join)(e,"..","..","..","..","packages","kritik-library","framework.json")]}function m(e){return JSON.parse((0,f.readFileSync)(e,"utf8"))}function K(e,t){(0,f.mkdirSync)((0,u.dirname)(e),{recursive:!0}),(0,f.writeFileSync)(e,JSON.stringify(t,null,2)+`
...
Pass --domain-name "<display name>" to define it, or use an existing domain code.`);r.domains=[...r.domains??[],{code:a,name:n.domainName}],d=a}return K(s,r),{path:s,overlay:r,replaced:o>=0,...d!==void 0?{addedDomain:d}:{}}}var C=`scaffold-criterion.js \u2014 add a project-specific Kritik criterion, or print an issue skeleton
...
${C}`);let o=r.slice(2);if(o==="template"||o==="force"||o==="help"){n.add(o);continue}let a=e[++s];a===void 0&&p(`scaffold-criterion: --${o} needs a value`),o in i?i[o].push(a):t[o]=a}return{single:t,many:i,flags:n}}function j(e,t,i,n,s){let r=b(_(t,e),y(e)),o=(r.criteria??[]).find(c=>c.id===i);o||p(`scaffold-criterion: no criterion "${i}" in the pack or the overlay.
