 ...
 */
"use strict";var D=require("node:fs"),h=require("node:path");var g=e=>Array.isArray(e)?e:[];var x=["critical","high","medium","low","info"];var O={critical:[20,25],high:[12,19],medium:[6,11],low:[2,5],info:[1,1]};function b(e,t){if(!t||typeof t!="object")return e;let i=[...g(e.domains)];for(let r of g(t.domains)){if(typeof r?.code!="string"||r.code==="")continue;let o=i.findIndex(a=>a?.code===r.code);o>=0?i[o]=r:i.push(r)}let n=[...g(e.criteria)];for(let r of g(t.criteria)){if(typeof r?.id!="string"||r.id==="")continue;let o=n.findIndex(a=>a?.id===r.id);o>=0?n[o]=r:n.push(r)}let s=e.scales||t.scales?{...e.scales??{},...t.scales??{}}:void 0;return{...e,domains:i,criteria:n,...s?{scales:s}:{}}}function $(e){let t=e?.scales?.severity_buckets,i={...O};if(!t||typeof t!="object")return i;for(let n of x){let s=t[n];Array.isArray(s)&&typeof s[0]=="number"&&typeof s[1]=="number"&&(i[n]=[s[0],s[1]])}return i}function v(e,t){let i=typeof e.impact=="number"?e.impact:0,n=typeof e.likelihood=="number"?e.likelihood:0,s=i*n,r=$(t),o=[...x].sort((a,c)=>r[c][0]-r[a][0]);for(let a of o)if(s>=r[a][0])return a;return"info"}function S(e,t){let i=v(e,t),n=e.cost==="S";return i==="critical"?"P0":i==="high"?n?"P0":"P1":i==="medium"?n?"P1":"P2":i==="low"&&n?"P2":"P3"}function R(e,t){return e.replace(/\{(\w+)\}/g,(i,n)=>t[n]??i)}function E(e,t){let{surface:i,finding:n,library:s}=t,r=e.level_anchors??{},o=t.level===void 0||t.level===""?"":String(t.level),a=o===""?"{observed_level}":o,c=t.targetLevel!==void 0&&t.targetLevel!==""?String(t.targetLevel):o===""?"{target_level}":String(Math.min(Number(o)+1,4)),d={surface:i,observed_level:a,target_level:c,observed_level_name:r[`l${a}`]??"{observed_level_name}",target_level_name:r[`l${c}`]??"{target_level_name}",target_anchor_text:r[`l${c}`]??"{target_anchor_text}",impact:String(n?.impact??e.default_impact??3)};n!==void 0&&(d.likelihood=String(n.likelihood),d.evidence_bullets_with_file_paths=n.evidence,d.risk_narrative=n.detail,typeof n.remediation=="string"&&n.remediation!==""&&(d.remediation_step_1=n.remediation));let l=e.issue??{},C=[...new Set([...l.labels??["quality"],i])],w=R(l.body_skeleton??"",d);return{title:R(l.title_template??`[Quality] ${e.id} on {surface}`,d),labels:C,body:n===void 0?w:`${w}
${q(n,s)}`,...typeof e.remediation=="string"&&e.remediation!==""?{remediation:e.remediation}:{}}}function q(e,t){let i=["","---",`<sub>Kritik finding \`${e.id}\` \u2014 **${v(e,t)} / ${S(e,t)}** (impact ${e.impact} x likelihood ${e.likelihood}, cost ${e.cost})</sub>`,"","**Evidence**",e.evidence];return typeof e.remediation=="string"&&e.remediation!==""&&i.push("","**Remediation**",e.remediation),i.join(`
`)}var f=require("node:fs"),u=require("node:path");var Q="docs/quality";var N="criteria.custom.json";var I="library.json";function F(e,t){return[...t!==void 0?[(0,u.join)(t,Q,I)]:[],(0,u.join)(e,"..","references",I),(0,u.join)(e,"..","..","..","..","packages","kritik-library","framework.json")]}function m(e){let t=(0,f.readFileSync)(e,"utf8");try{return JSON.parse(t)}catch(i){throw new Error(`${e}: not valid JSON \u2014 ${i.message}`)}}function K(e,t){(0,f.mkdirSync)((0,u.dirname)(e),{recursive:!0}),(0,f.writeFileSync)(e,JSON.stringify(t,null,2)+`
`)}function _(e,t){for(let i of F(e,t))if((0,f.existsSync)(i))return m(i);throw new Error(`Kritik: no criteria pack found. Looked in:
  ${F(e,t).map(i=>(0,u.resolve)(i)).join(`
  `)}`)}var k=e=>(0,u.join)(e,Q,N);function y(e){let t=k(e);return(0,f.existsSync)(t)?m(t):null}function p(e){process.stderr.write(`${e}
...
${P}`);let o=r.slice(2);if(o==="template"||o==="force"||o==="help"){n.add(o);continue}let a=e[++s];a===void 0&&p(`scaffold-criterion: --${o} needs a value`),o in i?i[o].push(a):t[o]=a}return{single:t,many:i,flags:n}}function j(e,t,i,n,s){let r=b(_(t,e),y(e)),o=(r.criteria??[]).find(c=>c.id===i);o||p(`scaffold-criterion: no criterion "${i}" in the pack or the overlay.
Known ids start with: ${(r.criteria??[]).slice(0,6).map(c=>c.id).join(", ")}\u2026`);let a=E(o,{surface:n,level:s});process.stdout.write(`Title: ${a.title}
