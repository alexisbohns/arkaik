...
export const WOBBLE_ICONS: WobbleIcon[] = [
  ...
  { name: "calendar-range", seed: 11 },
  { name: "chart-pie", seed: 4 },
  { name: "check", seed: 11 },
  ...
  { name: "layout-grid", seed: 14 },
  { name: "leaf", seed: 5 },
  { name: "library-big", seed: 7 },
  ...
  { name: "pen-tool", seed: 9 },
  { name: "pencil", seed: 4 },
  { name: "pencil-ruler", seed: 1 },
